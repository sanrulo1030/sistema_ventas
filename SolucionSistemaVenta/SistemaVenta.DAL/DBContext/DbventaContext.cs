...
namespace SistemaVenta.DBContext;
...
public partial class DbventaContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240CFBA9B668");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843F7FF8D19C");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF483BD03719A");
        ...
        {
            entity.HasKey(e => e.IdNegocio).HasName("PK__Negocio__70E1E107E35549FE");
        ...
        {
            entity.HasKey(e => e.IdNumeroCorrelativo).HasName("PK__NumeroCo__25FB547ECD540338");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A132E8401134");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F769BA39088");
        ...
        {
            entity.HasKey(e => e.IdRolMenu).HasName("PK__RolMenu__CD2045D8D953D159");
        ...
        {
            entity.HasKey(e => e.IdTipoDocumentoVenta).HasName("PK__TipoDocu__A9D59AEEAB233291");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A6D79E9062");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D561414AE8C9F");
